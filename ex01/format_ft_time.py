...
#                       have 4 decimal places with commas as thousands
#                       separators.
# {current_time:.2e}  - This formats the current_time as a floating-point
#                       number in scientific notation with 2 decimal places.

print(
    f"Seconds since {epoch_date}: {current_time:,.4f} or {current_time:.2e} \
